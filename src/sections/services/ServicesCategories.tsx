...
// Also exports categorySlug() used by the dynamic [id] route.
            ...
            return (
              ...
              >
                <Link
                  ...
                  className="group flex h-full flex-col bg-white border border-neutral-200 hover:bg-black hover:border-black transition-colors duration-300 overflow-hidden"
                >
