...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <>
      ...
      >
        <div className="relative w-full grid grid-cols-[1fr_auto_1fr] items-center px-4 sm:px-6">
          {/* Left Navigation (Desktop) */}
          <nav className="hidden min-[1181px]:flex items-center justify-start space-x-7 xl:space-x-9">
            {navLinks.map((link) => (
              <button
                key={link.name}
          ...
          {/* Center Brand Logo — slightly left of center (~20px) within the grid */}
          <div className="flex-shrink-0 flex items-center justify-center z-10 -translate-x-5 sm:-translate-x-5">
            <button
